...
| 어린이집 수집 | 매월 첫째 목 1시 | CPMS cpmsapi030 API (01:00 고정 — 아래 §CPMS 키 공유 참조, 04:30 이후 금지). **배치 100 은 `infra.childcare_updated_at` 오래된 순(NULL 최우선) 순환**(V053·PR #451, 세션 392 — 옛 ORDER BY 부재로 매월 같은 100개만 재갱신돼 901/2,938 단지가 5개월 미수집 방치되던 결함 수정. 첫 실전 = 2026-10-01 목. 전 단지 한 바퀴 ≈ 30개월 — 배치 상향은 CPMS 일 1,000콜 공유 쿼터 결정 대기) |
