...
const NOTICE_MESSAGES: Record<PropertyTaxNoticeKey, { title: string; body: string; tone: Tone }> = {
  disclaimer: {
    ...
    title: "면책 안내",
    body:
      "본 계산기는 표준 기준 참고치입니다. 합산배제·공동명의·법인 단일세율·부부 공동명의 1주택자 특례 + 1세대1주택 재산세 공정시장가액비율 차등(43~45%, 지방세법 시행령 §109)을 반영했습니다. 다음 1건 미반영 (다음 업데이트): 종부세 안의 공제할 재산세액 산정 단순화. 향교/종교는 산식 영향 없는 신고 절차 특례라 본 도구에서 별도 처리 불필요. 정확한 세액은 세무사 상담 권장.",
  },
  ...
  "consult-experts": {
    ...
    title: "세무사 상담 권장",
    body:
      "합산배제·공동명의·법인 단일세율·부부 공동명의 1주택자 특례 + 1세대1주택 재산세 공정시장가액비율 차등(43~45%, §109)을 반영했습니다. 1건 미반영: 종부세 안의 공제할 재산세액 산정 단순화. 합산배제 신청 자격·부부 공동명의 1주택자 자격은 본 도구가 자동 검증하지 않습니다 (세무사 상담 권장). 향교/종교는 산식 영향 없는 신고 절차 특례.",
  },
