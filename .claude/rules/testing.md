...
절차·판정·함정 원문(≈15KB: 대기 조건 두 갈래·mock 고정·baseline 재생성 7단계·헤더 전용 장·`check:visual-guard` 4항)은
baseline 을 만질 때만 필요해 **`frontend/e2e/README.md` §시각 회귀 절차·판정·함정** 으로 옮겼다(규칙 파일 다이어트).
