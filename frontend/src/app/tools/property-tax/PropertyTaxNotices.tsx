...
const NOTICE_MESSAGES: Record<PropertyTaxNoticeKey, { title: string; body: string; tone: Tone }> = {
  disclaimer: {
    ...
    title: "면책 안내",
    body:
      "본 계산기는 표준 기준 참고치입니다. 합산배제·공동명의·법인 단일세율·부부 공동명의 1주택자 특례를 반영했습니다. 종부세 안의 공제할 재산세액 단순화 1건만 미반영 (다음 업데이트). 향교/종교는 산식 영향 없는 신고 절차 특례라 본 도구에서 별도 처리 불필요. 정확한 세액은 세무사 상담 권장.",
  },
  ...
  "corporation-flat-rate-applied": {
    ...
    title: "법인 단일세율 적용",
    body:
      "종부세법 §9③ — 법인 보유 주택은 누진세율이 아닌 단일세율 (2주택 이하 2.7% / 3주택 이상 5.0%) 적용. 종부세 기본공제 9억/12억도 미적용 (개인 공제 차단).",
  },
  ...
  "consult-experts": {
    ...
    title: "세무사 상담 권장",
    body:
      "합산배제·공동명의·법인 단일세율·부부 공동명의 1주택자 특례를 반영했습니다. 종부세 안의 공제할 재산세액 단순화 (1주택 공정시장가액비율 43~45% 추가 인하 미반영) 1건만 다음 업데이트로 미루어집니다. 합산배제 신청 자격·부부 공동명의 1주택자 자격은 본 도구가 자동 검증하지 않습니다 (세무사 상담 권장). 향교/종교는 산식 영향 없는 신고 절차 특례.",
  },
  "spouse-joint-single-house-applied": {
    tone: "info",
    title: "부부 공동명의 1주택자 특례 적용",
    body:
      "종부세법 §10의2 (공동명의 1주택자 과세특례) — 부부 공동소유 1주택일 때 특례 신청 시 1인 합산 납세 → 12억 공제 + 세액공제 80% 가능 (납세의무자 연령·보유 기준). 자격 요건은 본인 책임 확인: 다른 세대원 무주택 + 배우자 다른 주택 무 + 매년 9.16~9.30 신청 (별지 제30호 서식, 혼인관계증명서 첨부). 자격 미충족 시 추징 가능, 세무사 상담 권장.",
  },
};
