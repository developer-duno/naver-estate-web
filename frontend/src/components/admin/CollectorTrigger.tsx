...
const HELP =
  ...
  "누르면 서버에서 받기 시작하고, 진행과 결과는 아래 '수집 작업 목록'에서 볼 수 있어요. " +
  "지금 도는 중인 작업은 두 번 돌지 않게 버튼이 잠겨요";

// 이 버튼이 있는 /admin/crawl 에 실제로 있는 표를 가리킨다 — '지금 돌아가는 작업' 줄은 대시보드에만 있다
export const STARTED_TEXT = "시작했어요 — 진행 상황은 아래 '수집 작업 목록'에서 볼 수 있어요";
