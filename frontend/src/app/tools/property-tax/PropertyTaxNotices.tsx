...
const NOTICE_MESSAGES: Record<PropertyTaxNoticeKey, { title: string; body: string; tone: Tone }> = {
  disclaimer: {
    ...
    title: "면책 안내",
    body:
      "본 계산기는 표준 기준 참고치입니다. v2 에서 합산배제·공동명의·법인 단일세율을 반영했습니다. 종부세 안의 공제할 재산세액 단순화 + 부부 공동명의 12억 추가 공제 2건만 미반영 (다음 업데이트). 향교/종교는 산식 영향 없는 신고 절차 특례라 본 도구에서 별도 처리 불필요. 정확한 세액은 세무사 상담 권장.",
  },
  ...
  "consult-experts": {
    ...
    title: "세무사 상담 권장",
    body:
      "v2 에서 합산배제·공동명의·법인 단일세율을 반영했습니다. 종부세 안의 공제할 재산세액 단순화 (1주택 공정시장가액비율 43~45% 추가 인하 미반영) + 부부 공동명의 12억 추가 공제 2건만 다음 업데이트로 미루어집니다. 합산배제 신청 자격 가부는 본 도구가 자동 검증하지 않습니다 (세무사 상담 권장). 향교/종교는 산식 영향 없는 신고 절차 특례.",
  },
};
