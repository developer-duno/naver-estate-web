...
| `apis.data.go.kr/1613000` (국토부) | 우리 + 자매 | 일 10,000 공유 — 단 한도는 창구(서비스)별이라 실거래가와 K-apt 는 따로 센다(세션 420·421 실측). 옛 "매월 10일 토요일 skip" 은 세션 421 에 삭제(미분양 building-info 는 K-apt 창구) |
