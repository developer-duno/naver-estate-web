...
| ~~complex-visual baseline~~ ✅ 세션 147 근본 fix (98f1f94 — applyComplexMocks 에 /api/users/me + user_profiles mock 2종 추가, 141 010cbea 우연 통과의 진짜 원인 해소) | (해소) | 세션 190 실측 = main 최근 20건 CI 중 complex-visual 실패 0건 (7건 연속 success). baseline png 마지막 변경 ffe23b0(135) 이후 안정 |
