...
| BE pytest | `backend/tests/` | **1594개** (세션 395 — 전체 1회 실측 1574 passed + 8 skipped + 6 xfailed = **1588**(합산 관례, 세션 393) + 본 세션 매물 상세 재시도 상한 PR 회귀 6건. 이전 문서값 1530(세션 390)과 +58 = 50차 규칙 갱신. 세션 391~394 PR #442~#459 누적분) |
