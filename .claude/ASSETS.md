...
- 보유세: `property-tax-types.ts` `PropertyTaxNoticeKey` (39개, 세션 115 PDF #16 4종 추가) + `SpecialHousesRateApplyInput` (PDF #13 4종, 세션 113) + `HoldPeriodSpecialMode` (PDF #16 라디오 3상태, 세션 115)
