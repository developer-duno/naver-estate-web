...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    title: "미분양 상세 진행바 8종 30초 독법 — 손님 응대 카드",
    description:
      "세대수·최고층·주차·건폐율·미분양률·전세율·6개월 취소율·소음도 8 진행바를 emerald/amber/rose 3 단계로 30초에 판독. DB 실측 분포 정합 임계값 + 손님 응대 30초 워크플로.",
    date: "2026-05-13",
    category: "미분양",
    readingTime: 7,
  },
  {
    ...
    description:
      "개요·분양 정보·거래 통계·주변환경·위치 5 단원에 30+ 필드와 진행바 8종이 어떻게 분포되는지 한 글로 정리. 시공사·신용등급·HUG 보증 신뢰 지표부터 미분양률·전세가율·취소율 진행바 색상까지 손님 앞에서 5분에 단지 신뢰성 답을 만드는 워크플로.",
    date: "2026-05-16",
    category: "미분양",
    readingTime: 7,
  },
