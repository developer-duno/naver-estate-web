...
SCHEDULER_JOB_META: dict[str, dict] = {
    ...
    "backfill_detail_dawn": {"name": "상세 백필 00:20(키 드리프트 대응)", "schedule": "매일 00:20", "env": "BACKFILL_DETAIL_ENABLED"},
    "backfill_detail_noon": {"name": "상세 백필 12:20(키 드리프트 대응)", "schedule": "매일 12:20", "env": "BACKFILL_DETAIL_ENABLED"},
