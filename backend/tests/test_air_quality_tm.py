...
실사고: `tm_y` 에 false northing 이 통째로 빠져 한국 전역이 음수였고, 그 결과 공유 DB
`infra.air_station_name` 이 **전국 3,068 단지에 8종류**만 붙었다(제주 "남원읍" 한 곳에
**2,007곳** — 서울·수원 아파트 포함). 전국 측정소는 600곳이 넘는다.
