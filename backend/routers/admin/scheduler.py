...
SCHEDULER_JOB_META: dict[str, dict] = {
    ...
    "popular_1030": {"name": "인기 단지 크롤링 10:30", "schedule": "매일 10:30", "env": "POPULAR_CRAWL_ENABLED", "env_default": "true"},
    "popular_1430": {"name": "인기 단지 크롤링 14:30", "schedule": "매일 14:30", "env": "POPULAR_CRAWL_ENABLED", "env_default": "true"},
    "popular_1900": {"name": "인기 단지 크롤링 19:00", "schedule": "매일 19:00", "env": "POPULAR_CRAWL_ENABLED", "env_default": "true"},
