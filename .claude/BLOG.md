...
> 23편 발행 (draft 0편). posts.ts BlogCategory 4종 = 시세 분석 / 세금 / 도구 활용 / 미분양.
> 새 글 발행 시 본 파일 표 1행 + 발행일 git log 실측 동시 갱신 의무.

## 발행 글 23편 (BlogCategory 4종)
...
- 세금 6편째: (현재 5편 = 계산기 우산 + 양도세·보유세·종부세 합산배제·비과세 요건) 추가 후보 협의 — 부부 공동명의·임대주택은 기존 글 중복으로 제외
