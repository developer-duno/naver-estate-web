...
| V063 | storage.objects 정책 "Admins can view license docs" 삭제 (이름과 달리 로그인 사용자 전체에 license-docs 버킷 읽기를 허용 → 클라이언트 읽기 0, backend 서명 URL 만 — 세션 417) | 적용 예정 — 세션 417 이 운영 적용 뒤 이 행에 시각 기입 |
