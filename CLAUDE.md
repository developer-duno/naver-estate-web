...
| BE pytest | `backend/tests/` | **1800개** (세션 402 실측 `--collect-only`, **10 PR 전량 머지된 main `2e99e90` 기준** — 직전 1762 대비 **+38**. 상세 백필(#511, `test_backfill_detail.py` 20건) + 채움률 감시(#512, `test_field_drift_monitor.py` 12건) + 스케줄러 출처(#513) 보강분. ⚠ 작업반 보고를 옮기지 말고 **매번 직접 재실측**, [[feedback-baseline-number-needs-own-measure]]. 옛 문서값 1762·1733(s401)·1680(s399)) |
