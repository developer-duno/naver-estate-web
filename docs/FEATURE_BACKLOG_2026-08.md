...
- [x] **2단계 — 데이터 모집단 크기 확인 (완료, 2026-08-24 prod 실측)**: `complexes` 63,967단지
      중 좌표(latitude/longitude) NULL **0건**(활성 매물 보유 9,454단지도 0건) — 지도에 안 뜨는
      단지 없음. 클러스터링 파라미터 튜닝은 실사용 관찰 후 필요 시(세션 381).
