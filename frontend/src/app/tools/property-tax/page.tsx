    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
      <section className="text-center mb-8 sm:mb-12">
        ...
        <div className="mt-4 p-3 sm:p-4 bg-amber-50 border border-amber-200 rounded-lg text-left text-xs sm:text-sm text-amber-900">
          <strong>적용범위:</strong> 1세대1주택·일반·다주택(2/3주택+) 모두 지원. 국세청 PDF 16개 출처 — 산식 추정 0건 박제.
        </div>
        ...
        <div className="mt-2 p-3 sm:p-4 bg-gray-50 border border-gray-200 rounded-lg text-left text-xs sm:text-sm text-gray-600">
          <strong>면책:</strong> 표준 계산 참고치입니다. <strong>공동명의·합산배제·법인 단일세율·부부 공동명의 1주택자 특례 + 1세대1주택 재산세 공정시장가액비율 차등(§109) + 종부세 공제할 재산세액(§4의2) 모두 반영 완료 — 산식 추정 0건 박제</strong>. 향교/종교는 산식 영향 없는 신고 절차 특례라 별도 처리 불필요. 정확한 세액은 세무사 상담 권장.
          <br />
